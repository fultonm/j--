...
class Type {
	 ...
	 * if (1) Any method declared in the class is abstract, or (2) Its superclass
	 * has an abstract method which is not overridden here.
	 * 
	 ...
	 * @return true iff all corresponding types of argTypes1 and argTypes2 match.
	 */
	...
	/**
	 * Return the simple (unqualified) name for this Type. Eg, String in place of
	 * java.lang.String.
	 * 
	 ...
	 * form of the name. Eg, java/lang/String for java.lang.String.
	 * 
	...
	/**
	 * Return the Java (and so j--) denotation for the specified type. Eg, int[],
	 * java.lang.String.
	 * 
	...
	/**
	 * Find an appropriate method in this type, given a message (method) name and
	 * it's argument types. This is pretty easy given our (current) restriction that
	...
	/**
	 * Find an appropriate constructor in this type, given it's argument types. This
	...
	/**
	 * Check the accessibility of a member from this type (that is, this type is the
	 * referencing type).
	 * 
	...
	/**
	 * Resolve this type in the given context. Notice that this has meaning only for
	 * TypeName and ArrayTypeName, where names are replaced by real types. Names are
	...
	public Type resolve(Context context) {
		...
		if (resolvedType == null) {
			...
			try {
				...
				JAST.compilationUnit.reportSemanticError(line, "Unable to locate a type named %s",
						name);
