...
class JMinusAssignOp extends JAssignment {
	 ...
	 * string concat doesn't make sense with -=
	 * 
	 * @param context context in which names are resolved.
	 * @return the analyzed (and possibly rewritten) AST subtree.
	 */
...
class JMultAssignOp extends JAssignment {
	...
	/**
	 * Analyze the lhs and rhs, rewrite rhs as lhs * rhs
	 * 
	 * @param context context in which names are resolved.
	 * @return the analyzed (and possibly rewritten) AST subtree.
	 */
...
/**
 * The AST node for a <<= expression. A <<= expression has two operands: a lhs
 * and a rhs.
 */

class JBWLShiftAssignOp extends JAssignment {
	...
	public JBWLShiftAssignOp(int line, JExpression lhs, JExpression rhs) {
		super(line, "<<=", lhs, rhs);
	}
...
class JBWRShiftAssignOp extends JAssignment {
	...
	public JBWRShiftAssignOp(int line, JExpression lhs, JExpression rhs) {
		super(line, ">>=", lhs, rhs);
	}
...
class JBWAndAssignOp extends JAssignment {
...
class JBWXorAssignOp extends JAssignment {
	...
	public JBWXorAssignOp(int line, JExpression lhs, JExpression rhs) {
		super(line, "^=", lhs, rhs);
	}
...
class JBWOrAssignOp extends JAssignment {
	...
	public JBWOrAssignOp(int line, JExpression lhs, JExpression rhs) {
		super(line, "|=", lhs, rhs);
	}
