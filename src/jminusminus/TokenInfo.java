...
enum TokenKind {
	...
	CONTINUE("continue"), DEFAULT("default"), DOUBLE("double"), DO("do"), ELSE("else"),
	ENUM("enum"), EXTENDS("extends"), FALSE("false"), FINAL("final"), FINALLY("finally"),
	...
	SUPER("super"), SWITCH("switch"), SYNCHRONIZED("synchronized"), THIS("this"), THROW("throw"),
	THROWS("throws"), TRANSIENT("transient"), TRUE("true"), TRY("try"), VOID("void"),
	VOLATILE("volatile"), WHILE("while"), PLUS("+"), ASSIGN("="), DEC("--"), EQUAL("=="), GT(">"),
	INC("++"), LAND("&&"), LOR("||"), LE("<="), LT("<"), GE(">="), LNOT("!"), NOT_EQUAL("!="),
	MINUS("-"), PLUS_ASSIGN("+="), MINUS_ASSIGN("-="), MULT_ASSIGN("*="), DIV_ASSIGN("/="),
	MOD_ASSIGN("%="), BWLSHIFT_ASSIGN("<<="), BWRSHIFT_ASSIGN(">>="), BWAND_ASSIGN("&="),
	BWXOR_ASSIGN("^="), BWOR_ASSIGN("|="), STAR("*"), DIV("/"), MOD("%"), LPAREN("("), RPAREN(")"),
	LCURLY("{"), RCURLY("}"), LBRACK("["), RBRACK("]"), SEMI(";"), COMMA(","), DOT("."), BWAND("&"),
	BWOR("|"), BWXOR("^"), BWCOMP("~"), BWLSHIFT("<<"), BWRSHIFT(">>"), BWZEROFILLRSHIFT(">>>"),
	TERNARY_TEST("?"), TERNARY_ELSE(":"), IDENTIFIER("<IDENTIFIER>"), INT_LITERAL("<INT_LITERAL>"),
